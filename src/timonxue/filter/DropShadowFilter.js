    ...
    */
    var DropShadowFilter = (function (_super) {
        ...
        **/
        ...
        DropShadowFilter.prototype.getAngle = function () {
            return this._angle;
        };

        DropShadowFilter.prototype.setAngle = function (value) {
        ...
        * @default 4
        **/
        DropShadowFilter.prototype.getDistance = function () {
            return this._distance;
        };

        DropShadowFilter.prototype.setDistance = function (value) {
        ...
        **/
        ...
        DropShadowFilter.prototype.setColor = function (value) {
        ...
        * @default 0
        **/
        DropShadowFilter.prototype.getBlurX = function () {
            return this._blurFilter.blurX;
        };

        DropShadowFilter.prototype.setBlurX = function (value) {
        ...
        * @default 0
        **/
        DropShadowFilter.prototype.getBlurY = function () {
            return this._blurFilter.blurY;
        };

        DropShadowFilter.prototype.setBlurY = function (value) {
        ...
        * @default 1
        **/
        DropShadowFilter.prototype.getQuality = function () {
            return this._blurFilter.quality;
        };

        DropShadowFilter.prototype.setQuality = function (value) {
        ...
        **/
        DropShadowFilter.prototype.getBounds = function () {
            if (this.inner) {
                return null;
            } else {
        ...
        **/
        ...
        DropShadowFilter.prototype.applyFilterWithBmd = function (bmd) {
        ...
        **/
        ...
        DropShadowFilter.prototype.setOffset = function (distance, angle) {
    ...
    tx.DropShadowFilter = DropShadowFilter;
})(tx || (tx = {}));
