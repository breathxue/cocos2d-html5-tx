...
(function (tx) {
    ...
    */
    var ImageViewMovieClip = (function (_super) {
        __extends(ImageViewMovieClip, _super);
        function ImageViewMovieClip(iv, fps) {
            ...
            this.iv = this.widget;
            var headName = this.iv._textureFile;
            var plistName;
            var mmtextures;

            //如果是spriteFrame
            if (this.iv._imageTexType == ccs.TextureResType.plist) {
                //去除.png
                headName = tx.Utils.GetAliceName(headName);

                //寻找plist
                plistName = tx.TextureAtlas.FindPlistInDict(headName);
                if (plistName == null) {
                    throw new Error("plistName is null, name = " + headName);
                }

                //获得贴图集
                mmtextures = tx.Attach.getTextureAtlas(headName).getNames(headName);
                this.mTexture = this.iv._textureFile;
                this.mFrameScript = [];
                this.iv.schedule(function () {
                    _this.advanceTime(cc.Director.getInstance().getAnimationInterval());
                }, cc.Director.getInstance().getAnimationInterval());

                var numFrames = mmtextures.length;
                ...
                this.mTextures = mmtextures.concat();
                ...
                this.setCurrentFrame(mmtextures.indexOf(this.mTexture) + 1);
            } else {
                throw new Error("this._imageTexType != plist");
                return;
            }
        }
        ImageViewMovieClip.prototype.destroy = function () {
            this.mTexture = null;
            this.mTexture = null;
            this.mTextures = null;
        ...
        *  duration is omitted, the default framerate is used (as specified in the constructor). */
        ImageViewMovieClip.prototype.addFrame = function (texture, sound, duration) {
        ...
        ImageViewMovieClip.prototype.addFrameAt = function (frameID, texture, sound, duration) {
            if (typeof sound === "undefined") { sound = null; }
            if (typeof duration === "undefined") { duration = -1; }
        ...
        ImageViewMovieClip.prototype.removeFrameAt = function (frameID) {
            if (frameID < 0 || frameID >= this.getNumFrames()) {
                trace("Invalid frame id");
            }
        ...
        ImageViewMovieClip.prototype.getFrameTexture = function (frameID) {
            if (frameID < 0 || frameID >= this.getNumFrames()) {
                trace("Invalid frame id");
            }
        ...
        ImageViewMovieClip.prototype.setFrameTexture = function (frameID, texture) {
            if (frameID < 0 || frameID >= this.getNumFrames()) {
                trace("Invalid frame id");
            }
        ...
        *  is displayed. */
        ...
        ImageViewMovieClip.prototype.getFrameDuration = function (frameID) {
            if (frameID < 0 || frameID >= this.getNumFrames()) {
                trace("Invalid frame id");
            }
        ...
        ImageViewMovieClip.prototype.setFrameDuration = function (frameID, duration) {
            if (frameID < 0 || frameID >= this.getNumFrames()) {
                trace("Invalid frame id");
            }
        ...
        ImageViewMovieClip.prototype.play = function () {
            this.mPlaying = true;
        };

        /** Pauses playback. */
        ImageViewMovieClip.prototype.pause = function () {
            this.mPlaying = false;
        };

        /** Stops playback, resetting "currentFrame" to zero. */
        ImageViewMovieClip.prototype.stop = function () {
            this.mPlaying = false;
            this.setCurrentFrame(1);
        };

        ImageViewMovieClip.prototype.gotoAndPlay = function (v) {
            this.mPlaying = true;
            this.setCurrentFrame(v);
        };

        ImageViewMovieClip.prototype.gotoAndStop = function (v) {
            this.mPlaying = false;
            this.setCurrentFrame(v);
        };

        ImageViewMovieClip.prototype.addFrameScript = function (v, f, _this) {
        ...
        // helpers
        ImageViewMovieClip.prototype.updateStartTimes = function () {
        ...
        // IAnimatable
        /** @inheritDoc */
        ImageViewMovieClip.prototype.advanceTime = function (passedTime) {
        ...
        ImageViewMovieClip.prototype.isComplete = function () {
            return !this.mLoop && this.mCurrentTime >= this.getTotalTime();
        };

        /** The total duration of the clip in seconds. */
        ImageViewMovieClip.prototype.getTotalTime = function () {
        ...
        ImageViewMovieClip.prototype.getCurrentTime = function () {
            return this.mCurrentTime;
        };

        /** The total number of frames. */
        ImageViewMovieClip.prototype.getNumFrames = function () {
            return this.mTextures.length;
        };

        /** Indicates if the clip should loop. */
        ImageViewMovieClip.prototype.getLoop = function () {
            return this.mLoop;
        };

        ImageViewMovieClip.prototype.setLoop = function (value) {
            this.mLoop = value;
        };

        /** The index of the frame that is currently displayed. */
        ImageViewMovieClip.prototype.getCurrentFrame = function () {
            return this.mCurrentFrame + 1;
        };

        ImageViewMovieClip.prototype.setCurrentFrame = function (value) {
            value--;
            if (value < 0) {
                value = 0;
            }
        ...
        *  relatively to the previous value. */
        ImageViewMovieClip.prototype.getFps = function () {
            return 1.0 / this.mDefaultFrameDuration;
        };

        ImageViewMovieClip.prototype.setFps = function (value) {
            if (value <= 0) {
        ...
        *  is reached. */
        ImageViewMovieClip.prototype.isPlaying = function () {
            if (this.mPlaying)
                return this.mLoop || this.mCurrentTime < this.getTotalTime();
            else
                return false;
        ...
        ImageViewMovieClip.prototype.runFrameScript = function () {
        ...
        ImageViewMovieClip.prototype._getTexture = function () {
            return this.mTexture;
        };

        ImageViewMovieClip.prototype._setTexture = function (value) {
            if (value == null) {
                trace("Texture cannot be null");
            } else if (value != this.mTexture) {
                this.mTexture = value;
                this.iv.loadTexture(this.mTexture, ccs.TextureResType.plist);
            }
        };
        return ImageViewMovieClip;
    })(tx.WidgetEx);
    tx.ImageViewMovieClip = ImageViewMovieClip;
})(tx || (tx = {}));
//# sourceMappingURL=ImageViewMovieClip.js.map
