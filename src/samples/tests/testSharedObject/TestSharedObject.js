...
var TestSharedObject = (function () {
    function TestSharedObject(root) {
        this._root = root;

        //        this.test1();
        this.test2();
    }
    TestSharedObject.prototype.test2 = function () {
    ...
    TestSharedObject.prototype.test1 = function () {
        tx.SharedObjectUtil.init("GAMENAME111");
        this._so = tx.SharedObjectUtil.getLocal("test1");
...
//# sourceMappingURL=TestSharedObject.js.map
